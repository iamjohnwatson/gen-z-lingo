const words = [
    ...
    { text: "suss", color: "#a5ffd6", explanation: "Suss is short for 'suspicious,' used to describe something or someone that seems off. It exploded in 2020 thanks to the game Among Us, where players call out 'suss' behavior. Example: 'He's acting suss, I think he's lying.' Gen Z loves it for gaming and memes. It's been huge for a few years now." },
];
